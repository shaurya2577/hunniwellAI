...
def main():
    ...
    if args.extract:
        from platforms.innovator.pro_innovator.innovator_portal_reader import (
    ...
    if args.radar is not None:
        from platforms.innovator.pro_innovator.radar_portal_reader import (
            merge_records,
            parse_radar_html,
            write_csv,
        )
    ...
    if args.live or args.download:
        from platforms.innovator.pro_innovator.run_downloader import main as live_main
