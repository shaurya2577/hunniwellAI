...
Or: python -m platforms.resi.run_downloader [options]
"""
import argparse
import getpass
import logging
...
def run_auto_loop(
    ...
    """
    from platforms.resi.recordings import macro as macro_module
...
def run_company_loop_only(
    ...
    try:
        ...
        logging.error("Could not import platforms.resi.recordings.macro: %s", e)
        return
...
def run_investor_auto_loop(page, context, test_one: bool = False) -> None:
    ...
    """
    from platforms.resi.recordings import investor_macro as inv_macro
...
def run_playback_loop(page, context, sector: str) -> None:
    ...
    try:
        ...
        logging.error("Could not import platforms.resi.recordings.macro: %s. %s", e, macro_instructions)
        return
